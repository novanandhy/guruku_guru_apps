package com.example.chorryiga.gurukuguru.GlobalUse;

/**
 * Created by Chorry on 01/08/2017.
 */
...
//param: id, id_user
    public static String LOWONGAN_DELETE = URLpath+"lowongan_update.php";
...
//param: id,id_guru,hari,keterangan,status
